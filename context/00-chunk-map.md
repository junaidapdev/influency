...
|---|---|---|---|---|
| 00 | Repo & tooling foundation | `chunk/00-foundation` | — | pnpm + Turborepo monorepo (frontend + backend, shared types in backend/shared), Vite+React+TS strict, Tailwind+shadcn, ESLint/Prettier, env→config module, constants/error/http modules, response-envelope helper, `.gitignore`, InsForge SDK client, committed `/context` + `AGENTS.md`. |
